...
Input_FilePath='/staging2/reserve/flagship/chia2831/TEST_2000_genome_VCFgz/Merge_2000_genome_ByChr/merged_recode_vcf/chr20/'
...
/staging/reserve/aging/chia2831/bin/bcftools merge -0 -l ${samplelist_dir}${filename} --threads 50 --force-samples --no-index -Ov -o ${Output_FilePath}${disease}_${Amount_of_Samples}_${ChrN}.merge.vcf
