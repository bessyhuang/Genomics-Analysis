...
Input_FilePath='/staging/reserve/aging/chia2831/FabryDisease/Merge_Fabry_Aging_total_186/merged_recode_vcf/chr6/'
...
sed -e 's/^/\/staging\/reserve\/aging\/chia2831\/FabryDisease\/Merge_Fabry_Aging_total_186\/merged_recode_vcf\/chr6\//' -i ${Case_Control_list}
